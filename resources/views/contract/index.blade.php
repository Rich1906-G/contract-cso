<x-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg relative md:mx-4 lg:mx-8 xl:m-4 "
            ...
            <div class="hidden lg:inline lg:w-auto">
                ...
                <div x-show="dropDownLaptop" @click.away="dropDownLaptop = false" x-cloak
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        ...
                        <li>
                            <form action={{ route('contract.importProses') }} method="POST"
                        ...
                        <li>
                            <form action="{{ route('contract.export') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
            ...
            <table class="w-full md:w-full md:text-sm text-center  text-gray-500 dark:text-gray-400 ">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr class="">
                        ...
                        <th class="px-4 py-3 lg:py-4 ">Branch</th>
                        <th class="p-px-4 py-3 lg:py-4 ">Customer ID</th>
                        <th class="px-4 py-3 lg:py-4 ">Username</th>
                        <th class="px-4 py-3 lg:py-4 ">CAE</th>
                        <th class="px-4 py-3 lg:py-4 ">Unit Head</th>
                        <th class="px-4 py-3 lg:py-4 ">Company</th>
                        <th class="px-4 py-3 lg:py-4 ">Service Type</th>
                        <th class="px-4 py-3 lg:py-4 ">Effective Date</th>
                        <th class="px-4 py-3 lg:py-4 ">Expired Date Contract</th>
                        <th class="px-4 py-3 lg:py-4 ">Contract Period (Month)</th>
                ...
                <tbody>
                    @foreach ($contract as $con)
                        <tr class="xl:text-base">
                            ...
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->nameuser }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->cae }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->unit_head }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->cpart_pic_lst }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->serv_ty }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->eff_dt }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->exp_dt }}</td>
                            <td class="px-4 py-3 lg:py-0  ">{{ $con->contr_period }}</td>
                            <td class="px-4 py-3 lg:py-4 w-auto">
                                ...
                                <button type="button"
                                    @click="hapus1Data = ! hapus1Data ; noHapus='{{ $con->contr_id }}';"
