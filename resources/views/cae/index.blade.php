    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden md:mx-4 lg:mx-8">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 ">
            <div class="w-full md:w-full lg:w-1/2 ">
                <form action="{{ route('cae.search') }}" method="GET">
                    <div
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($contractCAE as $con)
                        <tr class="border-b dark:border-gray-700">
                            <td class="px-4 py-3 lg:py-8 lg:px-4">{{ $contractCAE->firstItem() + $loop->index }}</td>
