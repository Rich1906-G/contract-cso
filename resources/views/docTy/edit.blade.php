<x-layout>
    ...
    <div class="row lg:container lg:mx-auto lg:px-4">
        <form action="{{ route('documentType.update', $docTy) }}" method="POST" class="">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="doc_ty_cd"
                        ...
                        autocomplete="off" value="{{ old('doc_ty_cd', $docTy->doc_ty_cd) }}">
                    </input>
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="doc_ty_nm"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('doc_ty_nm', $docTy->doc_ty_nm) }}">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="doc_ty_ord"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('doc_ty_ord', $docTy->doc_ty_ord) }}">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="doc_ty_desc"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('doc_ty_desc', $docTy->doc_ty_desc) }}">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="cre_by"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('cre_by', $docTy->cre_by) }}">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="date" name="cre_tm"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('cre_tm', $docTy->cre_tm) }}">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="upd_by"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('upd_by', $docTy->upd_by) }}">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="date" name="upd_tm"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        autocomplete="off" value="{{ old('upd_tm', $docTy->upd_tm) }}">
                </div>
            </div>
