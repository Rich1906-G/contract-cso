...
<body class="h-full">
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen bg-gray-800">
            <a href="https://www.cbn.id/en/cbn-fiber"
                class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="h-10 w-15" src="{{ asset('/storage/Logo_CBN_White.png') }}" alt="Your Company">
            </a>
            <div
