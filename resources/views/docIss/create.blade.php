<x-layout>
    ...
    <div class="row lg:container lg:mx-auto lg:px-4">
        ...
        <form action="{{ route('document.store') }}" method="POST" class="">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <label for="doc_isu_nm" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <label for="doc_isu_ord" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <label for="doc_isu_val" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
